...
gl.short_line_list = {"NvimTree", "packager", "Floaterm"}

local colors = {
  bg = "NONE",
  -- bg = "#2E3440",
  fg = "#81A1C1",
  line_bg = "NONE", lbg = "NONE",
  -- lbg = "#3B4252",
  fg_green = "#8FBCBB",
  yellow = "#EBCB8B",
  cyan = "#A3BE8C",
...
section.left[2] = {
  ViMode = {
    provider = function()
      ...
      cmd("hi GalaxyViMode guifg=" .. mode_color[mode])
      return "  " .. mode .. "  "
    end,
...
section.right[3] = {
  DiffAdd = {
    provider = "DiffAdd",
    condition = checkwidth and require("galaxyline.provider_vcs").check_git_workspace,
    separator = " ",
    icon = "  ",
...
section.right[4] = {
  DiffModified = {
    ...
    -- separator = " ",
    icon = " 柳",
    highlight = {colors.dark_yellow, colors.line_bg}
  }
}
section.right[5] = {
  DiffRemove = {
    ...
    -- separator = " ",
    icon = "  ",
    highlight = { '#f97583', colors.line_bg}
  }
}
