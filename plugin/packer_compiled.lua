...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'nvim-compe', 'friendly-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp-colors.nvim', 'nvim-lspinstall', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
