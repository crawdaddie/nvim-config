...
_G.packer_plugins = {
  ...
  ["galaxyline.nvim"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/galaxyline.nvim"
  },
  ["git-blame.nvim"] = {
    loaded = true,
  ...
  ["github-nvim-theme"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/github-nvim-theme"
  },
  ["lsp-colors.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/opt/lsp-colors.nvim"
  },
  ["lspsaga.nvim"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-compe"] = {
    after_files = { "/Users/adam/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
    config = { "\27LJ\2\n;\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\vconfig\17compe-config\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/opt/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-lspinstall"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/opt/nvim-lspinstall"
  },
  ["nvim-tree.lua"] = {
  ...
  ["stabilize.nvim"] = {
    ...
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/stabilize.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
  ...
  ["vim-dadbod"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/vim-dadbod"
  },
  ["vim-dadbod-ui"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/vim-dadbod-ui"
  },
  ["vim-fugitive"] = {
    loaded = true,
  ...
  vimkubectl = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/vimkubectl"
  }
}
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp-colors.nvim', 'lspsaga.nvim', 'nvim-lspinstall'}, { event = "BufRead *" }, _G.packer_plugins)]]
